...
The single thin client is the seam: add a method that calls another `/v1/...` route (e.g. one of queue.consume, queue.publish, queue.ack) and reuse it from your own code.
