...
> Design notes for **payment-job-review-queue** — a runnable typescript example that TypeScript worker that routes failed payment jobs to a review queue with stable event identity.
...
- **Feature code** — the actual task: payment-job-review.
